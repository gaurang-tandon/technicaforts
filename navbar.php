                    ...
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item mx-lg-3 rounded-3 dropdown">
                            ...
                            <ul class="dropdown-menu rounded-4 mx-auto py-3 px-2 my-0">
                                ...
                                <li>
                                    <a class="dropdown-item rounded-5 my-1 navbar-roboto-regular"
                        ...
                        <li class="nav-item mx-lg-3 rounded-3">
                            <a class="nav-link navbar-roboto-regular" href="./case_study.php">Case Study</a>
                        </li>
                        <li class="nav-item mx-lg-3 rounded-3">
                            <a class="nav-link navbar-roboto-regular" href="./about_us.php">About Us</a>
                        </li>
                        <li class="nav-item mx-lg-3 rounded-3">
                            <a class="nav-link navbar-roboto-regular" href="./resources.php">Resources</a>
                        </li>
                        <li class="nav-item mx-lg-3 rounded-3">
                            <a class="nav-link navbar-roboto-regular" href="./contact_us.php">Contact Us</a>
                        </li>
                    </ul>
                </div>
